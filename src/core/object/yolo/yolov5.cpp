...
int YOLOv5::EngineInference(const Mat& image, vector<ccutil::BBox>* result) {
...
int YOLOv5::EngineInferenceOptim(const vector<Mat>& images, vector<vector<ccutil::BBox>>* result) {
