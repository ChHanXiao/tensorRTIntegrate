...
int RetinaFace::EngineInference(const Mat& image, vector<ccutil::FaceBox>* result){
...
int RetinaFace::EngineInferenceOptim(const vector<Mat>& images, vector<vector<ccutil::FaceBox>>* result) {
