...
parser = argparse.ArgumentParser(description='Export DBFace ONNX')
parser.add_argument('--pretrained', help='pretrained dbface model', default='./dbface.onnx', type=str)
parser.add_argument('--input_shape', nargs='+', default=[3, 3, 640, 640], type=int, help='input shape.')
parser.add_argument('--onnx', help='onnx model', default='./dbface-b3.onnx', type=str)
