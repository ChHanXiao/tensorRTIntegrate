...
parser = argparse.ArgumentParser(description='Export dladcnv2 ONNX')
parser.add_argument('--pretrained', help='pretrained dladcnv2 model', default='./dladcnv2.onnx', type=str)
parser.add_argument('--input_shape', nargs='+', default=[3, 3, 640, 640], type=int, help='input shape.')
parser.add_argument('--onnx', help='onnx model', default='./dladcnv2-d3.onnx', type=str)
