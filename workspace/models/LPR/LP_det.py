...
import time
from LP_rec import plate_recogition
...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgpath', default='./imgs_b', type=str, help='show detection results')
    ...
    img_files = os.listdir(args.imgpath)
    for img_file in img_files:
        srcimg = cv2.imread(os.path.join(args.imgpath,img_file))
